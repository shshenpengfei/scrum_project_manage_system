 ...
 * @package     build
 * @version     $Id: model.php 3095 2012-06-27 06:54:48Z zhujinyonging@gmail.com $
...
class buildModel extends model
{
    ...
    public function getstoryInfoByStoryid($storyID, $version = 0, $setImgSize = false)
    {
        $spec     = $this->dao->select('id, name, assignedTo, project, status, consumed, `left`,deadline,estStarted,type')->from(TABLE_TASK)->where('story')->eq($storyID)->orderBy('id DESC')->fetchGroup('project');
        return $spec;
    }   
