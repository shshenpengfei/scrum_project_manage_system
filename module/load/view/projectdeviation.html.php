      ...
      <table class='table-1 fixed colored tablesorter datatable border-sep'>
        ...
        <?php foreach($projects as $id  =>$project):?>
          <tr class="a-center">
            ...
            <?php 
            if (isset($project->assignedto))
            {
            ?>
            <?php foreach($project->assignedto as $id  =>$assigninfo):?>
          
          <tr class="a-center">
            <td><?php echo $assigninfo->userrealname;?></td>
            <td align="center"><?php echo $assigninfo->plantitle;?></td>
            <td></td>
            <td><?php echo $assigninfo->story_count;?></td>
            <td></td>
            
            <td></td>
            <td></td>
            <td><?php echo $assigninfo->deptname;?></td>
            <td></td>
            <td></td>
            <td></td>
            <td>
