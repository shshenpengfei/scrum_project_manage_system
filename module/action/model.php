...
class actionModel extends model
{
     ...
     * @return int
     */
    public function create($objectType, $objectID, $actionType, $comment = '', $extra = '',$status=0)
    {
     ...
     * @return array
     */
    public function getDynamic($account = 'all', $period = 'all', $orderBy = 'date_desc', $pager = null, $productID = 'all', $projectID = 'all',$status = 0)
    {
        ...
        $actions = $this->dao->select('*')->from(TABLE_ACTION)
            ...
            ->beginIF($status ==1)->andWhere('status')->eq($status)->fi()
