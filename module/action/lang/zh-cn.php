...
$lang->action->desc->linkmember       = '$date, 由 <strong>$actor</strong> 增加了团队成员<strong>$extra</strong>。' . "\n";
...
$lang->action->label->unlinkmember              = '移除了成员';
...
$lang->action->label->home_beginwork               = '在家开始工作';
$lang->action->label->company_beginwork               = '在公司开始工作';
$lang->action->label->companywifi_beginwork               = '在公司wifi网络中开始工作';
$lang->action->label->local_beginwork               = '在本地开始工作';
$lang->action->label->otheraddress_beginwork               = '在其他未知地域开始工作';

$lang->action->label->home_endwork               = '在家结束工作';
$lang->action->label->company_endwork               = '在公司结束工作';
$lang->action->label->companywifi_endwork               = '在公司wifi网络中结束工作';
$lang->action->label->local_endwork               = '在本地开始工作';
$lang->action->label->otheraddress_endwork               = '在其他未知地域开始工作';

$lang->action->label->timeout_checkout               = '超时签出，异常。系统将把本次的下班时间置为空，当日状态设置为 未签离';
$lang->action->label->failed_checkout               = '下班失败';
...
$lang->action->label->sqlreview       = 'SQL评审|sqlreview|view|sqlID=%s';
...
$lang->action->search->label['unlinkmember']              = $lang->action->label->unlinkmember;
...
$lang->action->search->label['illegal_login']               = $lang->action->label->illegal_login;
