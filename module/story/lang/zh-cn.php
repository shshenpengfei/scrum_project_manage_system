...
$lang->story->statusList['active']    = '审核通过';
...
$lang->story->stageList['yufabu_released']   = '已发beta';
$lang->story->stageList['released']   = '已发外网';
...
$lang->story->ajaxGetUnFinishedFlag = '接口:获取未完成的任务标识';
$lang->story->ajaxGetFlagOfBacklog = '接口:获取是否允许计划标识';
