...
<form method='post' enctype='multipart/form-data' target='hiddenwin' id='dataform'>
    <table align='center' class='table-1 a-left'>
        ...
        <tr>
            <th class='rowhead'>公网HOST</th>
            <td><?php echo html::input('host_online', "", "class='text-3'");?></td>
        </tr>

        <tr>
            <th class='rowhead'>公网DB</th>
            <td><?php echo html::input('db_online', "", "class='text-3'");?></td>
        </tr>

        <tr>
            <th class='rowhead'>SQL内容</th>
