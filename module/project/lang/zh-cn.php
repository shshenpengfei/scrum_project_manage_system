...
$lang->project->sqlreview           = 'SQL列表';
$lang->project->stand           = '站立会管理';
/* 分组浏览。*/
...
$lang->project->taskSummary     = "本页共 <strong>%s</strong> 个任务，未开始<strong>%s</strong>，进行中<strong>%s</strong>，总预计<strong>%s</strong>工时，已消耗<strong>%s</strong>工时，剩余<strong>%s</strong>工时。合计预估成本<strong>%s</strong>元，合计最终成本<strong>%s</strong>元。";
...
$lang->project->linkStory             = '<span style="color: #ff0000">关联需求准备开发</span>';
