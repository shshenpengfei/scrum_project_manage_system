...
<div id='titlebar'>
  ...
  <div>
    ...
    if(!$bug->deleted)
    {
        ...
        if($this->bug->isClickable($bug, 'alphaResolved'))    common::printIcon('bug', 'alphaResolved', $params);
        if($this->bug->isClickable($bug, 'betaResolved'))    common::printIcon('bug', 'betaResolved', $params);
