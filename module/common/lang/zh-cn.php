 ...
 * @package     ZenTaoPMS
 * @version     $Id: zh-cn.php 3283 2012-07-02 14:19:23Z zhujinyonging@gmail.com $
...
$lang->menu->top = '贡献排行榜|report|top';
...
$lang->project->menu->sqlreview     = 'SQL|project|sqlreview|projectID=%s';
$lang->project->menu->stand     = array('link' => '站立会选任务|project|stand|projectID=%s', 'subModule' => 'task', 'alias' => 'grouptask,importtask');
...
$lang->sqlreview = new stdClass();
$lang->sqlreview->menu          = $lang->project->menu;
...
$lang->report->menu->worktime   = array('link' => '工作时间|report|worktime');
$lang->report->menu->gaiyaoworktime   = array('link' => '概要工作时间|report|gaiyaoworktime');
$lang->report->menu->delay   = array('link' => '延期|report|delay');
...
$lang->menugroup->sqlreview     = 'project';
