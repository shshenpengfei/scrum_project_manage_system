 ...
 * @package     mail
 * @version     $Id: model.php 3084 2012-06-23 02:33:14Z wwccss $
...
class mailModel extends model
{
     ...
     * @return void
     */
    public function send($toList, $subject, $body = '', $ccList = '', $includeMe = false,$name = '')
    {
        ...
        try 
        {
            $this->mta->setFrom($this->config->mail->fromAddress, $name);
    ...
    public function setReplyTo($address,$name){
        $this->mta->AddReplyTo($address,$name);
    }
}
