 ...
 * @package     config
 * @version     $Id: config.php 3347 2012-07-16 01:58:48Z shiyangyangwork@yahoo.cn $
...
define('TABLE_SQLREVIEW',     '`' . $config->db->prefix . 'sqlReview`');

define('TABLE_DELAYSTORY',     '`' . $config->db->prefix . 'delayStory`');
define('TABLE_DELAYTASK',     '`' . $config->db->prefix . 'delayTask`');
define('TABLE_CHECK',     '`' . $config->db->prefix . 'check`');
define('TABLE_STANDCHOOSE',     '`' . $config->db->prefix . 'standchoose`');
